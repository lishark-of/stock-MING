...
function selfTestFastApiValidator() {
  ...
  migrationRawDigest.data.safe_fields.authorization_nonce_digest = "redacted";
  ...
  migrationSecretField.data.safe_fields.api_key = "redacted";
  ...
  migrationToken.data.safe_fields.token = "redacted";
