...
function createApiState() {
  ...
  return {
    ...
    ledgers: {
      candidate: [
        localLedger("local_candidate_radar_cache", "cache_read_persisted_v05_candidate_local_batch", 1),
        localLedger("local_candidate_radar_worker_execution_recipe", "candidate_radar_worker_execution_recipe_ready_production_pending", 13),
        localLedger("local_candidate_radar_production_stage_scope_manifest", "candidate_radar_production_stage_scope_manifest_ready_production_pending", 15),
      ],
      next: [localLedger("local_next_session_cache", "cache_read")],
      qmt: [localLedger("local_qmt_readonly_decimal_replay", "cache_read_no_external_call")]
    },
    task: null,
    observedRequests: [],
    replayPayloads: []
