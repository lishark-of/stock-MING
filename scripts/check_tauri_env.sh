...
echo "tauri_local_unsigned_build_command=cd desktop && npm run tauri build"
echo "tauri_production_build_command=.venv/bin/python scripts/tauri_production_build.py"
echo "backend_autostart=tauri_app_open_local_fastapi"
echo "tauri_app_open_fastapi_autostart=true"
echo "tauri_app_open_autostart_scope=local_fastapi_only"
echo "tauri_app_open_autostart_external_calls=false"
