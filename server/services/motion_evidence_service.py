...
# currently consumes nineteen cache endpoints (an earlier review counted
# eighteen by omitting one of the three packet-detail reads).
...
_FASTAPI_CACHE_ENDPOINT_COUNT = 19
