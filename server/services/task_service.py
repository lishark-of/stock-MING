...
TASK_CATALOG = [
    ...
    {
        "task_type": "run_full_market_industry_membership_execution_request",
        "route": "POST /api/factor-quant/full-market-industry-membership-execution-request",
        "label": "创建全市场 PIT 行业成分采集 execution-request",
        "output_packet_key": "command_center_3_full_market_industry_membership_execution_request",
        "button_gated": True,
        "current_backend": "local_exact_scope_execution_request_only",
        "external_call_policy": "no_provider_call_request_ticket_only",
        "possible_external_sources": [],
        "future_external_sources": ["tushare:index_member_all"],
        "ltg": "LTG-03/LTG-04/LTG-13",
        "requires_current_full_market_provider_universe": True,
        "minimum_eligible_symbol_count": 3000,
        "required_exchanges": ["BSE", "SSE", "SZSE"],
        "requires_validated_trade_date": True,
        "requires_effective_dated_non_overlapping_membership": True,
        "source_api": "index_member_all",
        "small_pool_raw_evidence_is_production_evidence": False,
        "undefined_out_date_semantics_is_production_evidence": False,
    ...
    {
        "task_type": "run_full_market_industry_membership_provider_execution",
        "route": "POST /api/factor-quant/full-market-industry-membership-provider-execution",
        "label": "执行全市场 PIT 行业成分采集与原子证据晋升",
        "output_packet_key": "command_center_3_full_market_industry_membership_provider_execution",
        "button_gated": True,
        "current_backend": "persisted_request_bound_index_member_all_provider_runner",
        "external_call_policy": "explicit_post_and_acknowledgement_index_member_all_only",
        "possible_external_sources": ["tushare"],
        "ltg": "LTG-03/LTG-04/LTG-13",
        "requires_prior_task_type": "run_full_market_industry_membership_execution_request",
        "requires_current_full_market_provider_universe": True,
        "minimum_eligible_symbol_count": 3000,
        "required_exchanges": ["BSE", "SSE", "SZSE"],
        "allowed_tushare_apis": ["index_member_all"],
        "provider_query_is_new_values": ["Y", "N"],
        "requires_independent_out_date_semantic_evidence": True,
        "requires_external_root_owned_ed25519_semantic_authority": True,
        "application_can_generate_semantic_authority": False,
        "requires_external_root_owned_ed25519_generation_attestation": True,
        "generation_attestation_history_append_only": True,
        "application_can_generate_generation_attestation": False,
        "missing_generation_attestation_stages_without_pointer_promotion": True,
        "persists_raw_rows_and_pit_provenance": True,
        "writes_production_pointer": True,
        "atomic_generation_pointer_single_swap": True,
        "pit_promotion_fail_closed": True,
        "provider_execution_implemented": True,
        "cache_get_external_calls": False,
        "react_render_direct_provider_calls": False,
    ...
    {
        "task_type": "execute_full_market_factor_research",
        "route": "POST /api/worker/full-market-factor-execution",
        "label": "执行已验签全市场 Factor 截面研究",
        "output_packet_key": "command_center_3_factor_full_market_worker_production_acceptance",
        "button_gated": True,
        "current_backend": "local_verified_provider_industry_parquet_executor",
        "external_call_policy": "explicit_post_local_artifacts_only_no_dispatch",
        "possible_external_sources": [],
        "requires_current_head_clean": True,
        "requires_external_worker_attestation": True,
        "requires_provider_current_and_last_good": True,
        "requires_effective_dated_industry_membership": True,
        "requires_minimum_universe_size": 3000,
        "writes_versioned_factor_parquet": True,
        "writes_atomic_packet_task_bundle": True,
        "provider_refresh_executed": False,
        "worker_execution_triggered": False,
    ...
    },
    {
        ...
        "route": "POST /api/worker/candidate-radar-authoritative-cache-publish",
        "label": "发布已验签全市场 Radar 权威缓存",
        "output_packet_key": "command_center_3_candidate_radar_cache",
        "button_gated": True,
        "current_backend": "local_verified_worker_parquet_cache_writer",
        "external_call_policy": "explicit_post_local_artifact_only_no_dispatch",
        "possible_external_sources": [],
        "requires_current_head_clean": True,
        "requires_external_worker_attestation": True,
        "requires_minimum_universe_size": 3000,
        "writes_authoritative_candidate_cache": True,
        "writes_atomic_packet_task_bundle": True,
        "provider_refresh_executed": False,
        "worker_execution_triggered": False,
    ...
    {
        "task_type": "run_storage_backtest_results_local_execution",
        "route": "POST /api/storage/backtest-results/run-local",
        "label": "运行本地 backtest_results 研究回测",
        "output_packet_key": "command_center_3_storage_backtest_results_local_execution_packet",
        "button_gated": True,
        "current_backend": "bounded_local_backtest_pipeline",
        "external_call_policy": "confirmed_scope_bound_local_daily_parquet_only_no_external_call",
        "possible_external_sources": [],
        "ltg": "LTG-05",
        "requires_user_confirmation": True,
        "requires_bound_scope_hash": True,
        "reads_local_daily_parquet_rows": True,
        "writes_parquet_on_post": True,
        "atomic_parquet_promotion": True,
        "writes_real_backtest_result_rows": True,
...
TASK_CONTROL_PLANE_POST_ROUTES = [
    ...
    {
        "route": "POST /api/audit/external-production-consumers/{consumer}/promote",
        "label": "验证并提升外部签名生产消费者证明",
        "route_type": "local_external_consumer_control_plane",
        "button_gated": True,
        "current_backend": "local_ed25519_consumer_verification_registry",
        "external_call_policy": "explicit_post_signed_envelope_local_verification_only_no_external_call",
        "possible_external_sources": [],
        "requires_user_confirmation": True,
        "creates_task": False,
        "production_eligible": True,
        "authoritative_state": "external_ed25519_consumer_current_last_good_registry",
        "call_ledger_required": True,
        "does_not_execute_trades": True,
        "does_not_modify_strategy_action": True,
    },
    ...
    {
        "route": "POST /api/next-session/production-packet",
        "label": "从已验证 immutable dataset 写入 current-head 次日图谱生产包",
        "route_type": "local_production_packet_control_plane",
        "button_gated": True,
        "current_backend": "immutable_dataset_current_history_task_atomic_packet_producer",
        "external_call_policy": "explicit_post_local_immutable_readback_no_external_call",
        "possible_external_sources": [],
        "requires_user_confirmation": True,
        "creates_task": False,
        "production_eligible": True,
    ...
    },
    {
        ...
        "button_gated": True,
        "current_backend": "external_ed25519_approval_high_water_authenticated_journal",
        "external_call_policy": "explicit_post_external_file_verification_only_no_external_call",
        "possible_external_sources": [],
        "requires_user_confirmation": True,
        "creates_task": False,
        "production_eligible": True,
        "structural_production_blockers": [
            "external_trusted_approval_required",
            "external_rollback_resistant_high_water_required",
        ],
        "call_ledger_required": True,
        "does_not_execute_trades": True,
        "does_not_modify_strategy_action": True,
...
TASK_RETRY_POLICY_BY_TYPE: dict[str, dict[str, Any]] = {
    ...
    "execute_full_market_factor_research": {
        "manual_retry_allowed": True,
        "max_attempts": 2,
        "backoff": "manual_after_verified_input_or_head_change",
    },
    "publish_candidate_radar_full_market_cache": {
        "manual_retry_allowed": True,
        "max_attempts": 2,
        "backoff": "manual_after_verified_worker_or_evidence_change",
    },
    ...
    "run_storage_backtest_results_local_execution": {
        "manual_retry_allowed": True,
        "max_attempts": 1,
        "backoff": "manual_review_after_local_input_or_scope_change",
    },
