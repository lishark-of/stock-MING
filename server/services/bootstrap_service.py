...
def _search_quant_projection_workflow_contract(
    *,
    ...
    return {
        ...
        "provider_model_route_may_call_deepseek_when_user_approved": True,
...
def _search_quant_projection_submit_autostart_contract(
    *,
    ...
    return {
        ...
        "task_catalog_current_backend": "local_cache_pipeline",
        "task_catalog_external_call_policy": "local_search_quant_projection_receipt_only_no_external_call",
        "task_catalog_possible_external_sources": [],
        "task_catalog_future_external_sources": ["tushare", "deepseek"],
