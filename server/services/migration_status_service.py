...
LONG_TERM_GOAL_PROGRESS = [
    ...
    },
    {
        ...
        "current_state": "daily / daily_basic / moneyflow light path has real evidence; trade_cal has local dry-run and bound execution-request pre-provider tickets; extended interfaces have matrix, local QA, runbook, dry-run contracts, target-sample execution recipe, production stage-scope manifest, and durable evidence recipe.",
