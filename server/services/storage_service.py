...
DATASET_QUERY_PROJECTION_COLUMNS = {
    ...
    "daily": ["ts_code", "trade_date", "open", "high", "low", "close", "vol", "amount", "provider_scope_hash"],
    "daily_basic": ["ts_code", "trade_date", "turnover_rate", "pe_ttm", "pb", "total_mv", "circ_mv", "provider_scope_hash"],
    "moneyflow": [
        "ts_code",
        "trade_date",
        "buy_sm_amount",
