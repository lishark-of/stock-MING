...
class CandidateRadarOrdinaryEntryTests(unittest.TestCase):
    ...
    def test_search_quant_projection_keeps_task_boundary_visible(self):
        ...
        self.assertIn("明确未来单独 P5 task、model_ledger、sanitizer、安全字段和不阻塞 P1/P2/P3", self.page)
        ...
        self.assertIn("model_ledger、sanitizer/redaction、安全回退和不覆盖 action 都必须先满足", self.page)
