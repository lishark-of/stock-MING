...
class CandidateRadarOrdinaryEntryTests(unittest.TestCase):
    ...
    def test_search_quant_projection_keeps_task_boundary_visible(self):
        ...
        self.assertLess(ordinary_result_quick_index, ordinary_result_handoff_index)
    ...
    def test_ordinary_quant_projection_submit_does_not_auto_chain_provider_model(self):
        ...
        self.assertLess(summary_slice.index('aria-label="candidate radar ordinary p3 explainable result quick read"'), summary_slice.index('aria-label="candidate radar ordinary p3 result handoff index"'))
