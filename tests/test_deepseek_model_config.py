...
class DeepSeekModelConfigTests(unittest.TestCase):
    ...
    def test_command_center_migration_checkpoint_contract_requires_five_user_facing_answers(self):
        ...
        self.assertEqual(
            ...
            "future_migration_slices_follow_p0_to_p6_usable_path_or_name_blocker_exception",
        )
    ...
    def test_runtime_mode_policy_docs_reference_config_source(self):
        ...
        self.assertIn("page_open_rule", long_term_goals)
        self.assertIn("search_submit_rule", long_term_goals)
        self.assertIn("page open and confirmed search submit as mode-specific trigger surfaces", long_term_goals)
        self.assertIn("rather than render/search-typing side effects", long_term_goals)
