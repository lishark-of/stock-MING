...
class CommandCenter3FrontendScaffoldTests(unittest.TestCase):
    ...
    def test_motion_clarity_system_is_accessible_and_visual_only(self):
        ...
        self.assertNotIn("setTimeout", app + packet_card + metric_grid + task_panel + task_receipt)
        self.assertNotIn("requestAnimationFrame", app + packet_card + metric_grid + task_panel + task_receipt)
