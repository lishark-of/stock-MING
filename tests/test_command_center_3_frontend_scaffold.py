...
class CommandCenter3FrontendScaffoldTests(unittest.TestCase):
    ...
    def test_read_only_pages_render_structured_cache_without_direct_python_calls(self):
        ...
        self.assertIn("Parquet / DuckDB Storage", (route_dir / "CommandCenterHome.tsx").read_text(encoding="utf-8"))
        self.assertIn("daily / moneyflow / factor_values", (route_dir / "CommandCenterHome.tsx").read_text(encoding="utf-8"))
