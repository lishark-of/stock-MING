...
class LayoutOrdinaryNavigationTests(unittest.TestCase):
    def test_five_ordinary_entries_follow_the_research_workflow(self):
        ...
        self.assertLess(source.index('{ key: "marginEtf", label: "ETF / 融资" }'), source.index('title: "研究辅助"'))
    ...
    def test_engineering_and_legacy_routes_are_not_in_primary_group(self):
        ...
        self.assertIn("普通投研主线：今日作战台 → 下一票雷达 → 股票量化推演 → 次日图谱", source)
