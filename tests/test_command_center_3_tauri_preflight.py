...
class CommandCenter3TauriPreflightTests(unittest.TestCase):
    ...
    def test_command_center_3_launcher_is_local_one_click_and_safe(self):
        ...
        self.assertIn("launcher opens #home by default; user can open #candidates next", source)
        ...
        self.assertIn("P0 success handoff: after readiness, launcher opens #home by default; user can open #candidates next", source)
    ...
    def test_command_center_3_launcher_check_only_does_not_start_or_open(self):
        ...
        self.assertIn("P0 success handoff: after readiness, launcher opens #home by default; user can open #candidates next", output)
    ...
    def test_p0_post_startup_readback_checklist_is_visible_and_read_only(self):
        ...
        self.assertIn("少于 4/4 时按失败段处理；4/4 时进入下一票雷达。", page)
