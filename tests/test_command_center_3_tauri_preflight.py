...
class CommandCenter3TauriPreflightTests(unittest.TestCase):
    ...
    def test_command_center_3_launcher_is_local_one_click_and_safe(self):
        ...
        self.assertIn("launcher opens #home by default; user can open #candidates/candidate-radar-search-quant-projection next", source)
        ...
        self.assertIn("P0 success handoff: after readiness, launcher opens #home by default; user can open #candidates/candidate-radar-search-quant-projection next", source)
    ...
    def test_command_center_3_launcher_check_only_does_not_start_or_open(self):
        ...
        self.assertIn("P0 success handoff: after readiness, launcher opens #home by default; user can open #candidates/candidate-radar-search-quant-projection next", output)
