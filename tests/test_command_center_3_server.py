...
class CommandCenter3ServerServiceTests(unittest.TestCase):
    ...
    def test_worker_runtime_cache_reads_local_scaffold_without_starting_backends(self):
        ...
        self.assertEqual(worker_controls["retry_policy"]["status"], "planned")
        self.assertEqual(worker_controls["task_cancel"]["status"], "local_ready")
        self.assertEqual(worker_controls["concurrency_lock"]["status"], "planned")
        self.assertEqual(worker_controls["task_dedupe"]["status"], "partial_ready")
        self.assertEqual(worker_controls["task_logs"]["status"], "partial_ready")
