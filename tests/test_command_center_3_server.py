...
class CommandCenter3ServerServiceTests(unittest.TestCase):
    ...
    def test_task_records_include_safe_idempotency_and_lock_keys(self):
        ...
        self.assertFalse(task_b["lock_policy"]["lock_conflict_detected"])
        self.assertEqual(task_b["lock_policy"]["active_conflict_count"], 0)
        ...
        self.assertEqual(task_b["call_ledger"][-1]["api"], "local_task_dispatch_dedupe")
        self.assertEqual(task_b["call_ledger"][-1]["call_status"], "reused_active_task_no_external_call")
        ...
        self.assertEqual(listing["persistence"]["lock_conflict_audit_count"], 0)
        ...
        self.assertEqual(listing["call_ledger"][0]["lock_conflict_audit_count"], 0)
