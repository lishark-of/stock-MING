...
class CommandCenter3ServerServiceTests(unittest.TestCase):
    ...
    def test_storage_overview_covers_daily_moneyflow_and_factor_values(self):
        ...
        self.assertEqual(implementation["dataset_count"], 5)
        self.assertEqual(implementation["local_pipeline_dataset_count"], 1)
        self.assertEqual(implementation["future_button_gated_dataset_count"], 4)
        self.assertEqual(implementation["tushare_capable_dataset_count"], 3)
        ...
        self.assertEqual(implementation["state_counts"]["future_button_gated"], 4)
    ...
    def test_storage_dataset_catalog_is_independent_cache_only_endpoint(self):
        ...
        self.assertEqual(catalog["dataset_implementation_status"]["future_button_gated_dataset_count"], 4)
        self.assertEqual(catalog["dataset_implementation_status"]["tushare_capable_dataset_count"], 3)
