...
class CommandCenter3ServerServiceTests(unittest.TestCase):
    ...
    def test_task_catalog_documents_button_gated_external_boundaries(self):
        ...
        self.assertTrue(by_type["refresh_tushare_facts"]["lock_policy"]["audit_only"])
        ...
        self.assertFalse(by_type["refresh_tushare_facts"]["lock_policy"]["auto_blocks_task_creation"])
        ...
        self.assertTrue(by_type["refresh_tushare_facts"]["dedupe_policy"]["audit_only"])
        self.assertFalse(by_type["refresh_tushare_facts"]["dedupe_policy"]["cache_api_can_dedupe"])
        self.assertFalse(by_type["refresh_tushare_facts"]["dedupe_policy"]["auto_blocks_task_creation"])
    ...
    def test_worker_runtime_cache_reads_local_scaffold_without_starting_backends(self):
        ...
        self.assertEqual(worker_controls["task_dedupe"]["status"], "audit_ready")
    ...
    def test_task_records_include_safe_idempotency_and_lock_keys(self):
        ...
        self.assertTrue(task_a["lock_policy"]["audit_only"])
        ...
        self.assertFalse(task_b["lock_policy"]["lock_enforced"])
        self.assertTrue(task_b["lock_policy"]["lock_conflict_detected"])
        self.assertEqual(task_b["lock_policy"]["active_conflict_count"], 1)
        self.assertIn(task_a["task_id"], task_b["lock_policy"]["active_conflict_task_ids"])
        self.assertFalse(task_b["lock_policy"]["auto_blocks_task_creation"])
        ...
        self.assertFalse(task_a["dedupe_policy"]["dispatch_dedupe_enforced"])
        self.assertTrue(task_a["dedupe_policy"]["audit_only"])
        self.assertFalse(task_a["dedupe_policy"]["duplicate_detected"])
        self.assertEqual(task_a["dedupe_policy"]["active_duplicate_count"], 0)
        self.assertFalse(task_a["dedupe_policy"]["cache_api_can_dedupe"])
        self.assertFalse(task_b["dedupe_policy"]["dispatch_dedupe_enforced"])
        self.assertTrue(task_b["dedupe_policy"]["duplicate_detected"])
        self.assertEqual(task_b["dedupe_policy"]["active_duplicate_count"], 1)
        self.assertIn(task_a["task_id"], task_b["dedupe_policy"]["active_duplicate_task_ids"])
        self.assertFalse(task_b["dedupe_policy"]["auto_blocks_task_creation"])
        ...
        self.assertEqual(listing["call_ledger"][0]["dispatch_dedupe_enforced_count"], 0)
        ...
        self.assertEqual(listing["call_ledger"][0]["lock_enforced_task_count"], 0)
    ...
    def test_task_status_update_supports_failed_state_without_secret_leak(self):
        ...
        self.assertFalse(updated["dedupe_policy"]["auto_blocks_task_creation"])
