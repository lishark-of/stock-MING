...
export function postCandidateRadarQuantProjectionProviderModelAcceptance(payload: Record<string, unknown> = {}) {
  return request<TaskCreationData>("/api/candidate-radar/quant-projection-provider-model-acceptance", {
    method: "POST",
    body: JSON.stringify(payload)
  });
}
...
export function postCandidateRadarDeepScanWorker(payload: Record<string, unknown> = {}) {
  return request<TaskCreationData>("/api/candidate-radar/deep-scan-worker", {
    method: "POST",
    body: JSON.stringify(payload)
  });
}
...
export function postCandidateRadarProductionPromotionReview(payload: Record<string, unknown> = {}) {
  return request<TaskCreationData>("/api/candidate-radar/production-promotion-review", {
    method: "POST",
    body: JSON.stringify(payload)
  });
}
...
const LTG_NEXT_ACCEPTANCE_LOCAL_ROUTES = new Set([
  ...
  "/api/candidate-radar/provider-parity-execution-request",
