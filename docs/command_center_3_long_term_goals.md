...
- Typed projection consumption by Factor Test Lab / full-pool research, richer UI filters, and query result contract hardening beyond the current local DuckDB read path.
