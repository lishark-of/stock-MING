...
3. Add batch execution through task pipeline.
4. Add cross-sectional rank, zscore, neutralization, and result summaries.
5. Keep UI as progress/result display only.
