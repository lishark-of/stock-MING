...
5. 如果资料显示他的风格发生变化，必须用【风格变化】标出。
6. 如果资料提到当前市场更适合或不适合他，必须用【市场适应期】标出。
7. 如果资料体现当前关注方向、公司、行业、宏观判断，要提炼为【当前关注】。
8. 如果资料提到加仓、减仓、重仓、调仓，要提炼为【持仓变化】。
9. 如果资料提到某个行业机会或风险，要提炼为【行业判断】。
