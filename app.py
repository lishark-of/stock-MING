        ...
        if market_type == "US_STOCK":
            ...
            if btn_jp_ai:
                with st.spinner("正在加载东京券商估值模型..."):
                    jp_prompt = f"""
你是顶级全球宏观对冲基金的亚洲区首席科技与策略分析师。请对 {target}（当前价 ¥{price}）出具冷血的机构级研报。

请抛弃纯粹的高息价值防守逻辑，强制带入类似美股的【成长溢价与宏观博弈】框架，并结合日本本土特色：
1. 汇率双刃剑 (USD/JPY)：当前日元汇率动向对该企业的真实影响（是放大出口型科技巨头利润的利器，还是增加内需型企业成本的毒药）？
2. 全球产业链溢价：如果它是科技/半导体/高端制造股，请评估其在全球AI算力周期或供应链中的壁垒与弹性；如果不是，请评估其核心商业模式的成长性。
3. 资金定性博弈：当前华尔街热钱与外资，更倾向于将其视作“价值避险资产”还是“高弹性成长资产”？资金是在抢筹还是撤离？
4. 操作指令：拒绝废话。给出明确的三个月操作建议与核心逻辑。
"""
            if btn_jp_whale:
