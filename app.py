...
STREAMLIT_LEGACY_MODE_STATUS = "legacy/admin/debug"
COMMAND_CENTER_3_OFFICIAL_ENTRY = "React/Vite/Tauri + FastAPI"
STREAMLIT_LEGACY_NOTICE = (
...
def render_streamlit_legacy_admin_notice():
...
render_streamlit_legacy_admin_notice()
