...
PACKET_SPECS = [
    ...
    },
    {
        ...
        "label": "产业链瓶颈扫描",
        "area": "analysis",
        "owner": "command_center_analysis_methods.py / analysis_engine.py / app.py",
        "source": "button-gated DeepSeek prompt + existing evidence packets + Bayesian score trigger",
        "refresh_policy": "button_gated",
        "external_call_policy": "button_gated",
        "deepseek_policy": "manual_only",
        "writes_session_state": True,
        "legacy_workspace_entry": "综合推演中心 / 瓶颈扫描",
        "local_api_path": "/api/command-center/packets/command_center_chokepoint_scan_packet",
        "description": "手动输入题材后执行卡脖子拆链、精度降级、反向伪证和 15 维贝叶斯评分；打开页面不自动调用 DeepSeek，不写入 strategy action 或次日操作图谱。",
    },
    {
        "packet_key": "command_center_serenity_method_radar_packet",
        "label": "Serenity 方法雷达",
        "area": "analysis",
        "owner": "command_center_serenity_method_radar.py / app.py",
        "source": "user screenshot baseline + optional button-gated GitHub probe",
        "refresh_policy": "button_gated",
        "external_call_policy": "button_gated",
        "deepseek_policy": "never",
        "writes_session_state": True,
        "legacy_workspace_entry": "综合推演中心 / 瓶颈扫描 / Serenity 方法雷达",
        "local_api_path": "/api/command-center/packets/command_center_serenity_method_radar_packet",
        "description": "展示用户截图固定基线、Gen1-Gen4 防幻觉演进和方法归纳；GitHub 当前状态仅手动校验，不进入交易评分或策略动作。",
    },
    {
        "packet_key": "command_center_factor_library_packet",
        "label": "因子研究库",
        "area": "analysis",
        "owner": "command_center_factor_research.py / app.py",
        "source": "local factor definitions scaffold",
        "refresh_policy": "derived_display",
        "external_call_policy": "not_triggered",
        "deepseek_policy": "never",
        "writes_session_state": True,
        "legacy_workspace_entry": "综合推演中心 / 高级工具箱入口 / 因子研究实验室",
        "local_api_path": "/api/command-center/packets/command_center_factor_library_packet",
        "description": "Phase 1 因子定义库；只展示因子公式、依赖和风险边界，不回测、不评分、不进入 strategy action。",
    },
    {
        "packet_key": "command_center_factor_data_ledger_packet",
        "label": "因子数据血缘",
        "area": "data_governance",
        "owner": "command_center_factor_research.py / app.py",
        "source": "factor library + existing packet presence",
        "refresh_policy": "derived_display",
        "external_call_policy": "not_triggered",
        "deepseek_policy": "never",
        "writes_session_state": True,
        "legacy_workspace_entry": "综合推演中心 / 高级工具箱入口 / 因子研究实验室",
        "local_api_path": "/api/command-center/packets/command_center_factor_data_ledger_packet",
        "description": "Phase 1 因子数据血缘；只读展示 Tushare 接口依赖、PIT/缺失风险和本地 packet 可见性，不自动取数。",
    },
    {
        "packet_key": "command_center_factor_runtime_packet",
        "label": "因子运行值",
        "area": "analysis",
        "owner": "command_center_factor_research.py / app.py",
        "source": "button-gated factor quant hub light mode",
        "refresh_policy": "derived_display",
        "external_call_policy": "not_triggered",
        "deepseek_policy": "never",
        "writes_session_state": True,
        "legacy_workspace_entry": "综合推演中心 / 高级工具箱入口 / 2.0 多因子量化图谱",
        "local_api_path": "/api/command-center/packets/command_center_factor_runtime_packet",
        "description": "MVP light mode 因子运行值；只计算当前标的/持仓/关注池，不跑全市场重回测，不进入 strategy action。",
    },
    {
        "packet_key": "command_center_factor_test_packet",
        "label": "Factor Test Lab",
        "area": "analysis",
        "owner": "command_center_factor_research.py / app.py",
        "source": "factor test research metrics scaffold",
        "refresh_policy": "derived_display",
        "external_call_policy": "not_triggered",
        "deepseek_policy": "never",
        "writes_session_state": True,
        "legacy_workspace_entry": "综合推演中心 / 高级工具箱入口 / 2.0 多因子量化图谱",
        "local_api_path": "/api/command-center/packets/command_center_factor_test_packet",
        "description": "P5 因子检验实验室指标 scaffold；声明 IC/Rank IC/ICIR/分组收益/换手/成本后收益/PIT 检查，但当前不跑全市场重回测、不进入 strategy action。",
    },
    {
        "packet_key": "command_center_factor_score_packet",
        "label": "多因子评分",
        "area": "analysis",
        "owner": "command_center_factor_research.py / app.py",
        "source": "factor runtime packet local scoring",
        "refresh_policy": "derived_display",
        "external_call_policy": "not_triggered",
        "deepseek_policy": "never",
        "writes_session_state": True,
        "legacy_workspace_entry": "综合推演中心 / 高级工具箱入口 / 2.0 多因子量化图谱",
        "local_api_path": "/api/command-center/packets/command_center_factor_score_packet",
        "description": "多因子 support/suppress/neutral/missing/conflict 归类；缺失不当负面，Serenity/瓶颈不进入 composite score。",
    },
    {
        ...
        "area": "analysis",
        "owner": "command_center_factor_research.py / app.py",
        "source": "button-gated Tushare refresh + local factor runtime + optional manual DeepSeek explanation",
        "refresh_policy": "button_gated",
        "external_call_policy": "button_gated",
        "deepseek_policy": "manual_only",
        "writes_session_state": True,
        "legacy_workspace_entry": "综合推演中心 / 高级工具箱入口 / 2.0 多因子量化图谱",
        "local_api_path": "/api/command-center/packets/command_center_factor_quant_hub_packet",
        "description": "统一多因子证据层；Tushare/DeepSeek 仅按钮触发，只进入 evidence_effects 预览，不修改 strategy action、价格、持仓或 operation_zones。",
    },
    {
    ...
    {
        "packet_key": "command_center_cloud_memory_packet",
        "label": "云端外脑记忆摘要",
        "area": "legacy_workspace",
        "owner": "command_center_cloud_memory_packet.py",
        "source": "legacy cloud brain memories and manual feed writes",
        "refresh_policy": "manual_recovery",
        "external_call_policy": "button_gated",
        "deepseek_policy": "manual_only",
        "writes_session_state": True,
        "legacy_workspace_entry": "高级工具箱 / 云端外脑",
        "local_api_path": "/api/command-center/packets/command_center_cloud_memory_packet",
        "description": "云端投喂资料和历史记忆摘要；首页只读缓存，不自动读取 Supabase 或调用 DeepSeek。",
    },
    {
    ...
    {
        "packet_key": "command_center_data_health_visibility_summary",
        "label": "为什么搜不到",
        "area": "data_governance",
        "owner": "command_center_data_health_ledger.py / command_center_home_snapshot.py",
        "source": "home snapshot data health ledger",
        "refresh_policy": "derived_display",
        "external_call_policy": "not_triggered",
        "deepseek_policy": "never",
        "writes_session_state": False,
        "legacy_workspace_entry": "综合推演中心 / 数据新鲜度",
        "local_api_path": "/api/command-center/packets/command_center_data_health_visibility_summary",
        "description": "把权限不足、本会话跳过、近期无数据、缓存和可用接口整理成首页可见解释，不触发外部请求。",
    },
    {
        "packet_key": "command_center_data_health_timeline",
        "label": "接口健康时间线",
        "area": "data_governance",
        "owner": "command_center_data_health_ledger.py / command_center_home_snapshot.py",
        "source": "home snapshot data health ledger",
        ...
        "writes_session_state": False,
        "legacy_workspace_entry": "综合推演中心 / 数据新鲜度",
        "local_api_path": "/api/command-center/packets/command_center_data_health_timeline",
        "description": "按接口展示最近成功、最近失败、缓存/无数据和手动恢复入口，解释为什么以前可用但现在搜不到。",
    },
    {
    ...
    {
        "packet_key": "command_center_recovery_result_timeline",
        "label": "恢复结果时间线",
        "area": "recovery",
        "owner": "command_center_home_snapshot.py / visual_components.py",
        "source": "home snapshot derived recovery results",
        "refresh_policy": "derived_display",
        "external_call_policy": "not_triggered",
        "deepseek_policy": "never",
        "writes_session_state": False,
        "legacy_workspace_entry": "综合中心 / 数据恢复中心",
        "local_api_path": "/api/command-center/packets/command_center_recovery_result_timeline",
        "description": "最近手动恢复结果时间线，展示是否回流、使用缓存、仍受限或待验证。",
    },
    {
        "packet_key": "command_center_decision_priority_queue",
        "label": "决策优先恢复队列",
        "area": "recovery",
        "owner": "command_center_home_snapshot.py",
        "source": "home snapshot data recovery center",
        "refresh_policy": "derived_display",
        "external_call_policy": "not_triggered",
        "deepseek_policy": "never",
        "writes_session_state": False,
        "legacy_workspace_entry": "",
        "local_api_path": "/api/command-center/packets/command_center_decision_priority_queue",
        "description": "P0/P1/P2 数据恢复优先队列；供未来桌面前端直接读取，不触发数据请求。",
    },
    {
